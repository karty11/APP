...
public class CertifierEntity extends AuditFields {
    ...
    public boolean equals( Object o ) {
        ...
        return new EqualsBuilder().append( id, that.id ).append( certificate, that.certificate )
                .append( batchNumber, that.batchNumber ).append( trainingStartDate, that.trainingStartDate )
                .append( trainingEndDate, that.trainingEndDate ).append( issueDate, that.issueDate )
                .append( expirationDate, that.expirationDate ).append( recipientName, that.recipientName )
    ...
    public String toString() {
        ...
        return "{" + "id='" + id + '\'' + ", certificate=" + certificate + ", batchNumber='" + batchNumber + '\'' +
                ", trainingStartDate=" + trainingStartDate + ", trainingEndDate=" + trainingEndDate + ", issueDate=" +
                issueDate + ", expirationDate=" + expirationDate + ", recipientName='" + recipientName + '\'' +
                ", recipientEmail='" + recipientEmail + '\'' + ", recipientOrganization='" + recipientOrganization +
                '\'' + '}';
    }
