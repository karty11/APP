...
public class CertificateEntity extends AuditFields {
    ...
    @Override public boolean equals( Object o ) {
        ...
        return new EqualsBuilder().append( id, that.id )
                .append( issuingAuthority, that.issuingAuthority ).append( companyBranding, that.companyBranding )
                .append( name, that.name ).append( certificationCriteria, that.certificationCriteria )
