...
public interface CertificateService {
     ...
     */
    CertificateResponse addCertificate( CertificateRequest certificateRequest, String userId )
     ...
     * @throws AppException            - Incomplete conversions or repository operations.
     */
    CertificateResponse updateCertificate( String certificateId, CertificateRequest certificateRequest, String userId )
     ...
     * @throws EntityNotFoundException - Required entity does not exists.
     */
    CertificateResponse findCertificateById( String certificateId )
     ...
     * @throws AppException            - Incomplete conversions or repository operations.
     */
    String deleteCertificateById( String certificateId )
            throws InvalidInputException, EntityNotFoundException, AppException;
